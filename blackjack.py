...
def new_game():
    ...
    dealer_card_frame.grid(row=0, column=1, sticky='ew', rowspan=1)
    # embedded frame to hold the card images
...
new_game_button = tkinter.Button(button_frame, text="New Game", width=10, command=new_game)
new_game_button.grid(row=0, column=2)

shuffle_button = tkinter.Button(button_frame, text="Shuffle", width=10, command=shuffle)
